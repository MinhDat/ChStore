...
class ChTextStyle {
  ...
  static TextStyle content =
      TextStyle(color: ChColor.content, fontSize: ChTextSize.size24);
  ...
  static TextStyle detailPrice =
      TextStyle(fontSize: ChTextSize.size20, color: ChColor.primaryDart);
  ...
  static TextStyle price = TextStyle(fontSize: ChTextSize.size30);

  static TextStyle title =
      TextStyle(fontSize: ChTextSize.size14, fontWeight: FontWeight.bold);

  static TextStyle description = TextStyle(color: ChColor.initialization);

  static TextStyle button =
      TextStyle(fontSize: ChTextSize.size24, color: ChColor.main);
  ...
  static TextStyle cardPrice =
      TextStyle(fontSize: ChTextSize.size26, color: ChColor.title);

  static TextStyle cardCounter =
      TextStyle(fontSize: ChTextSize.size30, color: ChColor.primaryDart);
  ...
  static TextStyle method =
      TextStyle(color: ChColor.title, fontSize: ChTextSize.size22);

  static TextStyle bankname =
      TextStyle(color: ChColor.label, fontSize: ChTextSize.size26);

  static TextStyle normal =
      TextStyle(color: ChColor.initialization, fontSize: ChTextSize.size24);
  ...
  static TextStyle smallCardPrice =
      TextStyle(fontSize: ChTextSize.size33, color: ChColor.main);
  ...
  static TextStyle popularCategory =
      TextStyle(color: ChColor.primary, fontSize: ChTextSize.size22);

  static TextStyle popularTag =
      TextStyle(color: ChColor.primary, fontSize: ChTextSize.size20);
  ...
  static TextStyle itemName =
      TextStyle(fontSize: ChTextSize.size22, fontWeight: FontWeight.bold);

  static TextStyle link =
      TextStyle(fontSize: ChTextSize.size22, color: ChColor.link);
  ...
  static TextStyle cancel =
      TextStyle(fontSize: ChTextSize.size20, color: Colors.blueAccent);

  static TextStyle buttonCart(double textSize) =>
      TextStyle(fontSize: textSize, color: ChColor.main);

  static TextStyle flexColor(color) =>
      TextStyle(color: color, fontSize: ChTextSize.size26);
}
