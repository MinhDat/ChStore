          ...
          items: [
            BottomNavigationBarItem(
              icon: new Image.asset('icon/today-icon.png',
                  height: 22,
                  width: 22,
                  color: _index == 0 ? AppColor.primary : AppColor.unfocus),
            ...
            BottomNavigationBarItem(
              icon: new Image.asset('icon/toggle-menu-icon.png',
                  height: 22,
                  width: 22,
                  color: _index == 1 ? AppColor.primary : AppColor.unfocus),
              title: SizedBox.shrink(),
            ),
            BottomNavigationBarItem(
              icon: new Image.asset('icon/search-icon.png',
                  height: 22,
                  width: 22,
                  color: _index == 2 ? AppColor.primary : AppColor.unfocus),
              title: SizedBox.shrink(),
            ),
            BottomNavigationBarItem(
              icon: Icon(Icons.notifications,
                  color: _index == 3 ? AppColor.primary : AppColor.unfocus),
              title: SizedBox.shrink(),
            ),
            BottomNavigationBarItem(
              icon: Icon(Icons.person,
                  color: _index == 4 ? AppColor.primary : AppColor.unfocus),
              title: SizedBox.shrink(),
            ),
          ],
        ),
